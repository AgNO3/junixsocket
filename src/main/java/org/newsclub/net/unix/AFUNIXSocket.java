 ...
 */
public class AFUNIXSocket extends Socket implements UNIXSocket {
    ...
    public void bind ( SocketAddress bindpoint ) throws IOException {
        if ( ! ( bindpoint instanceof AFUNIXSocketAddress ) ) {
    ...
    public void sendCredentials ( byte data ) throws IOException {
        this.impl.sendCredentials(data);
    }


    public SocketCredentials recieveCredentials () throws IOException {
        return this.impl.receiveCredentials();
    }
